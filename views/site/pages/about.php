...
Для размещения своего объявления нужно  <B><a
            href="<?php echo Url::to(['user/registration']); ?>">зарегистрироваться</a></B>, затем
в специальной форме, нажав ссылку &quot;<a href="<?php echo Url::to(['lk/adverts/create']); ?>"><B>Добавить
        объявление</B></a>&quot; ввести его тему,
...
<div align=right><B>Администратор доски объявлений</B></div><BR>
