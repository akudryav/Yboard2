...
class SiteController extends Controller
{
    ...
    public function actionContact($id = null)
    {
        ...
        return $this->render('contact', ['model' => $form, 'user' => $user]);
    }
    ...
    public function actionGetRegions($id = "")
    {
        if ($id)
        {
            echo Html::dropDownList(
                'selectRegions', "", Location::Regions($id), [
    ...
    public function actionGetCities($id = "")
    {
        if ($id)
        {
            echo Html::dropDownList('selectCities', "", Location::Cities($id), [
