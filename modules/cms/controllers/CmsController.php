...
class CmsController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                'actions' => array('view', 'delete', 'sort', 'translit', 'getParentUrl'),
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Cms'])) {
            ...
            if ($model->save()) {
                if ($newParent = Cms::findOne($model->parent_id)) {
    ...
    public function actionAdmin($parent_id = 1) {
        ...
        $page = Cms::find('id=:id', array(':id' => $parent_id));
    ...
    function FckEditorAvailable() {
        $editorPath = Yii::getAlias('application.extensions.ckeditor.CKEditor');
