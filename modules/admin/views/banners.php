...
<style>
    ...
    <script>
        function show_banner(b_name, b_id) {
            ...
            /*
             $.get("<?= Url::to(['view/banners/show']) ?>?b_name=" + b_name + "&b_id=" + b_id,
         function (data){
        ...
        function create_block() {
            ...
            if (bl_name != null) {
                window.location = '<?= Url::to(['view/banners']) ?>?create_block=yes&new_name=' + bl_name;
            }
        }
        ...
        function delete_ads(bl_name, ads_id) {
            ...
            console.log(cf);
            if (cf) {
                window.location = '<?= Url::to(['view/banners']) ?>?delete_name=' + bl_name + '&delete_id=' + ads_id;
            }
        }
        ...
        function delete_block(bl_name) {
            ...
            if (cf) {
                window.location = '<?= Url::to(['view/banners']) ?>?delete_block=' + bl_name;
            }
        }
...
?>
    ...
    <div align='center' class='add_code_form'>
        ...
        <form method='post' name='insert_ads_form' action='<?= Url::to(['view/banners']) ?>'
